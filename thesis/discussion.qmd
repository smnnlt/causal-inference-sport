...
<!-- short introduction to special methods ("identification methods") -->

@angrist1999

### Covariate Balancing

<!-- maybe include matching & reweighting -->

@stuart2010 for an introduction.

@rosenbaum1983 as the first use of propensity scores. Maybe also @dehejia2002. @frölich2004 says that matching is better than reweighing, @busso2014 says not per se.

@king2019 says propensity score matching is bad (though not reweighing) and proposes @iacus2012; @iacus2011 instead. But @black says it is bad.

Solution?

Use cases and potential applications in sport?
