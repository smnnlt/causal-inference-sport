...
### Predicting Hypothetical Outcomes with Counterfactuals.

<!-- something with counterfactuals, but need to find an example. The concept needs to be introduced first-->
